...
union YYSTYPE
{
#line 16 "./src/imageprocessing.y" /* yacc.c:355  */
...
{
  "$end", "error", "$undefined", "STRING", "STRINGX", "VAR", "IGUAL",
  "EOL", "ASPA", "NUM", "CONTA", "INTEIRO", "SOMA", "$accept", "PROGRAMA",
...
{
       2,     6,     8,     3,     4,     7,     9,     0,    11,     0,
      10,     0,     0,    12,    13
};

static const yytype_int8 yycheck[] =
{
       0,     6,     3,     3,     4,     7,    10,    -1,    11,    -1,
       9,    -1,    -1,    11,    11
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 5:
#line 37 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
...
#line 1247 "y.tab.c" /* yacc.c:1646  */
  ...
  case 6:
#line 46 "./src/imageprocessing.y" /* yacc.c:1646  */
    {  
        double mean_clock = 0.0, mean_real_sec = 0.0, mean_real_usec = 0.0;

        imagem I = abrir_imagem((yyvsp[-5].strval));
        
        gettimeofday(&rt0, NULL);
        ct0 = clock();
        brilho(I, (yyvsp[-3].valor), (yyvsp[-4].cval), (yyvsp[-5].strval), (yyvsp[-2].inteiro), (yyvsp[-1].inteiro), (yyvsp[0].inteiro));        
        ct1 = clock();
        gettimeofday(&rt1, NULL);
        
        salvar_imagem((yyvsp[-7].strval), &I);
        liberar_imagem(&I);
...
#line 82 "./src/imageprocessing.y" /* yacc.c:1906  */
